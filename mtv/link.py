"""
link.py: interface and link abstractions for mtv
...
from mtv.log import info, error, debug
from mtv.util import makeIntfPair
...
class TCIntf(Intf):
    ...
    def bwCmds(self, bw=None, speedup=0, use_hfsc=False, use_tbf=False,
        ...
        if bw and (bw < 0 or bw > self.bwParamMax):
            ...
            # the same settings we had in the mtv-hifi code.
            if use_hfsc:
...
class OVSLink(Link):
    ...
    def __init__(self, node1, node2, **kwargs):
        ...
        try:
            ...
            from mtv.node import OVSSwitch
